"""
Django settings for wakafproject project.
...
ROOT_URLCONF = 'wakafproject.urls'
...
WSGI_APPLICATION = 'wakafproject.wsgi.application'
...
LOGIN_URL = 'wakafadmin:login'
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'

EMAIL_HOST = 'mail.paii.co.id'
